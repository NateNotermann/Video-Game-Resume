...
class BuildingRestaurant{
    constructor(x, y, w, h, image) { //  passing in x & y positions
        ...
        // -- ACTUAL Building size is relative to the actual image file size/dimensions. -- //
        this.width = 950//w //650 //default width // Added *2 on 12/27/23
        this.height = 700 //h //468 //default height // Added *2 on 12/27/23
        this.currentCropWidth = 950
        // this.image = MCTC
        this.frames = 0
        this.currentSprite = Restaurant
    }
    draw() { 
        // c.fillStyle = 'red' // draw a rectangle that matches the size and position of the Player Sprite
        // c.fillRect(this.position.x,  this.position.y, this.width, this.height)
